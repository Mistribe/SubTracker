...
class SummaryRequestBuilder extends BaseRequestBuilder<SummaryRequestBuilder> {
    ...
    SummaryRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/summary?top_providers={top_providers}&total_monthly={total_monthly}&total_yearly={total_yearly}&upcoming_renewals={upcoming_renewals}", pathParameters) ;
    /// Instantiates a new [SummaryRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    SummaryRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/summary?top_providers={top_providers}&total_monthly={total_monthly}&total_yearly={total_yearly}&upcoming_renewals={upcoming_renewals}", {RequestInformation.rawUrlKey : rawUrl}) ;
