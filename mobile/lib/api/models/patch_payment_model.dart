...
class PatchPaymentModel implements AdditionalDataHolder, Parsable {
    ...
    static PatchPaymentModel createFromDiscriminatorValue(ParseNode parseNode) {
        return PatchPaymentModel();
    }
