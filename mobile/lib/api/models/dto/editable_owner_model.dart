...
import './editable_owner_model_type.dart';
...
class EditableOwnerModel implements AdditionalDataHolder, Parsable {
    ...
    Map<String, void Function(ParseNode)> getFieldDeserializers() {
        ...
        deserializerMap['type'] = (node) => type_ = node.getEnumValue<EditableOwnerModelType>((stringValue) => EditableOwnerModelType.values.where((enumVal) => enumVal.value == stringValue).firstOrNull);
    ...
    void serialize(SerializationWriter writer) {
        ...
        writer.writeEnumValue<EditableOwnerModelType>('type', type_, (e) => e?.value);
