...
/// auto generated
class UpdatePaymentModel implements AdditionalDataHolder, Parsable {
    ...
    String? updatedAt;
    /// Instantiates a new [UpdatePaymentModel] and sets the default values.
    UpdatePaymentModel() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static UpdatePaymentModel createFromDiscriminatorValue(ParseNode parseNode) {
