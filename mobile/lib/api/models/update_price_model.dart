...
/// auto generated
class UpdatePriceModel implements AdditionalDataHolder, Parsable {
    ...
    DateTime? startDate;
    /// Instantiates a new [UpdatePriceModel] and sets the default values.
    UpdatePriceModel() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static UpdatePriceModel createFromDiscriminatorValue(ParseNode parseNode) {
