...
class PatchSubscriptionPaymentModel implements AdditionalDataHolder, Parsable {
    ...
    DateTime? updatedAt;
    /// Instantiates a new [PatchSubscriptionPaymentModel] and sets the default values.
    PatchSubscriptionPaymentModel() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static PatchSubscriptionPaymentModel createFromDiscriminatorValue(ParseNode parseNode) {
        return PatchSubscriptionPaymentModel();
    }
