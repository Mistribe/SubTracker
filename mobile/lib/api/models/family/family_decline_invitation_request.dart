...
/// auto generated
class FamilyDeclineInvitationRequest implements AdditionalDataHolder, Parsable {
    ...
    /// Instantiates a new [FamilyDeclineInvitationRequest] and sets the default values.
    FamilyDeclineInvitationRequest() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static FamilyDeclineInvitationRequest createFromDiscriminatorValue(ParseNode parseNode) {
        return FamilyDeclineInvitationRequest();
    }
