...
import './payments/payments_request_builder.dart';
...
class ItemRequestBuilder extends BaseRequestBuilder<ItemRequestBuilder> {
    ...
    ItemRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/subscriptions/{%2Did}", pathParameters) ;
    /// Instantiates a new [ItemRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    ItemRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/subscriptions/{%2Did}", {RequestInformation.rawUrlKey : rawUrl}) ;
