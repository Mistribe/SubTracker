...
class SubscriptionUpdateSubscriptionModel {
  /// Returns a new [SubscriptionUpdateSubscriptionModel] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SubscriptionUpdateSubscriptionModel &&
  ...
  /// Returns a new [SubscriptionUpdateSubscriptionModel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SubscriptionUpdateSubscriptionModel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SubscriptionUpdateSubscriptionModel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SubscriptionUpdateSubscriptionModel[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SubscriptionUpdateSubscriptionModel(
  ...
  static List<SubscriptionUpdateSubscriptionModel> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SubscriptionUpdateSubscriptionModel>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SubscriptionUpdateSubscriptionModel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SubscriptionUpdateSubscriptionModel> mapFromJson(dynamic json) {
    final map = <String, SubscriptionUpdateSubscriptionModel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SubscriptionUpdateSubscriptionModel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SubscriptionUpdateSubscriptionModel-objects as value to a dart map
  static Map<String, List<SubscriptionUpdateSubscriptionModel>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SubscriptionUpdateSubscriptionModel>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SubscriptionUpdateSubscriptionModel.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
