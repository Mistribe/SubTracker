...
class HealthApi {
  ...
  Future<Response> healthzLiveGetWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/healthz/live';
  ...
  ///
  /// Returns the health status of the application
  Future<Map<String, String>?> healthzLiveGet() async {
    final response = await healthzLiveGetWithHttpInfo();
