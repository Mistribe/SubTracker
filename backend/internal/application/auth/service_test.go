...
func TestMustGetUserId(t *testing.T) {
	...
	service := auth.NewAuthenticationService(user.NewMockRepository(t), family.NewMockRepository(t))
...
func TestMustGetFamilies(t *testing.T) {
	...
	service := auth.NewAuthenticationService(mockRepo, family.NewMockRepository(t))
