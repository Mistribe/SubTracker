...
func TestUpdateFamilyMemberCommandHandler(t *testing.T) {
	...
	t.Run("GetById returns error", func(t *testing.T) {
		...
		famID := uuid.New()
		cmd := command.UpdateFamilyMemberCommand{FamilyID: famID, FamilyMemberID: uuid.New()}
	...
	t.Run("Authorization denies returns error", func(t *testing.T) {
		...
		cmd := command.UpdateFamilyMemberCommand{FamilyID: famID, FamilyMemberID: m.Id(), Name: "Johnny",
	...
	t.Run("Member not found returns ErrFamilyMemberNotFound", func(t *testing.T) {
		...
		cmd := command.UpdateFamilyMemberCommand{FamilyID: famID, FamilyMemberID: uuid.New(), Name: "Johnny",
			Type: family.KidMemberType, UpdatedAt: option.None[time.Time]()}
	...
	t.Run("Validation error after update -> fault and no Save", func(t *testing.T) {
		...
		cmd := command.UpdateFamilyMemberCommand{FamilyID: famID, FamilyMemberID: m.Id(), Name: "",
			Type: family.KidMemberType, UpdatedAt: option.None[time.Time]()}
	...
	t.Run("Repository Save error propagates", func(t *testing.T) {
		...
		fam := makeFamilyWithMembers(famID, []family.Member{m})
		cmd := command.UpdateFamilyMemberCommand{FamilyID: famID, FamilyMemberID: m.Id(), Name: "Johnny",
			Type: family.KidMemberType, UpdatedAt: option.Some(time.Now())}
	...
	t.Run("Success with UpdatedAt Some sets exact time and updates fields", func(t *testing.T) {
		...
		cmd := command.UpdateFamilyMemberCommand{FamilyID: famID, FamilyMemberID: m.Id(), Name: newName, Type: newType,
			UpdatedAt: option.Some(ts)}
