...
import (
	...
	"github.com/mistribe/subtracker/internal/usecase/currency/command"
	"github.com/mistribe/subtracker/pkg/slicesx"
)

type CurrencyRefreshRatesEndpoint struct {
	handler ports.CommandHandler[command.RefreshCurrencyRatesCommand, command.RefreshCurrencyRatesResponse]
}
