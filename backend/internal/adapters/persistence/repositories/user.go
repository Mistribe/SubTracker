...
import (
	...
	persistence2 "github.com/mistribe/subtracker/internal/adapters/persistence/db"
...
type UserRepository struct {
	dbContext *persistence2.Context
}

func NewUserRepository(repository *persistence2.Context) ports.UserRepository {
