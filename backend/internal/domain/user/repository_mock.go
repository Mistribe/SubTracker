...
func (_mock *MockRepository) GetUserProfile(ctx context.Context, userId string) (Profile, error) {
	ret := _mock.Called(ctx, userId)
	...
	var r0 Profile
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (Profile, error)); ok {
		return returnFunc(ctx, userId)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) Profile); ok {
		r0 = returnFunc(ctx, userId)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockRepository_GetUserProfile_Call) Return(profile Profile, err error) *MockRepository_GetUserProfile_Call {
	_c.Call.Return(profile, err)
	return _c
}

func (_c *MockRepository_GetUserProfile_Call) RunAndReturn(run func(ctx context.Context, userId string) (Profile, error)) *MockRepository_GetUserProfile_Call {
	_c.Call.Return(run)
	return _c
}

// SaveProfile provides a mock function for the type MockRepository
func (_mock *MockRepository) SaveProfile(ctx context.Context, profile Profile) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, Profile) error); ok {
...
func (_c *MockRepository_SaveProfile_Call) Run(run func(ctx context.Context, profile Profile)) *MockRepository_SaveProfile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_SaveProfile_Call) RunAndReturn(run func(ctx context.Context, profile Profile) error) *MockRepository_SaveProfile_Call {
	_c.Call.Return(run)
	return _c
}
