...
func (o *SuccessResponse) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *SuccessResponse) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *SuccessResponse) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *SuccessResponse) SetCode(v string) {
	o.Code = &v
}
