...
func (o *DeleteWebhookResponse) GetCode() string {
...
func (o *DeleteWebhookResponse) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *DeleteWebhookResponse) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *DeleteWebhookResponse) SetCode(v string) {
	o.Code = &v
}
