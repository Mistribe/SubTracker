...
// ApiResult struct for ApiResult
...
func (o *ApiResult) GetResult() string {
...
func (o *ApiResult) GetResultOk() (*string, bool) {
	if o == nil || IsNil(o.Result) {
		return nil, false
	}
...
func (o *ApiResult) HasResult() bool {
	if o != nil && !IsNil(o.Result) {
		return true
	}
...
func (o *ApiResult) SetResult(v string) {
	o.Result = &v
}
