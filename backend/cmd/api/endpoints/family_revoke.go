...
type FamilyRevokeEndpoint struct {
	handler core.CommandHandler[command.RevokeMemberCommand, bool]
}

func NewFamilyRevokeEndpoint(handler core.CommandHandler[command.RevokeMemberCommand, bool]) *FamilyRevokeEndpoint {
