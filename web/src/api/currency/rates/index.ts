...
// @ts-ignore
import { createCurrencyGetRateResponseFromDiscriminatorValue, createHttpErrorResponseFromDiscriminatorValue, type CurrencyGetRateResponse, type HttpErrorResponse } from '../../models/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /currency/rates
 */
export interface RatesRequestBuilder extends BaseRequestBuilder<RatesRequestBuilder> {
     ...
     * @returns {Promise<CurrencyGetRateResponse>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<RatesRequestBuilderGetQueryParameters> | undefined) : Promise<CurrencyGetRateResponse | undefined>;
    /**
     * Get exchange rates for all currencies at a specific date
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const RatesRequestBuilderUriTemplate = "{+baseurl}/currency/rates{?date*}";
/**
...
export const RatesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createCurrencyGetRateResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
