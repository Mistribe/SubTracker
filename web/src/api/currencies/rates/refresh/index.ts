...
// @ts-ignore
import { createCurrencyRefreshRatesResponseFromDiscriminatorValue, createHttpErrorResponseFromDiscriminatorValue, type CurrencyRefreshRatesResponse, type HttpErrorResponse } from '../../../models/index.js';
// @ts-ignore
...
export interface RefreshRequestBuilder extends BaseRequestBuilder<RefreshRequestBuilder> {
     ...
     * @returns {Promise<CurrencyRefreshRatesResponse>}
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<CurrencyRefreshRatesResponse | undefined>;
    /**
     * refresh exchange rates for all currencies
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const RefreshRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createCurrencyRefreshRatesResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
