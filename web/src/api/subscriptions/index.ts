...
// @ts-ignore
import { createPaginatedResponseModelSubscription_SubscriptionModelFromDiscriminatorValue, type PaginatedResponseModelSubscription_SubscriptionModel } from '../models/dto/index.js';
// @ts-ignore
import { createHttpErrorResponseFromDiscriminatorValue, type HttpErrorResponse } from '../models/ginx/index.js';
// @ts-ignore
import { createSubscriptionModelFromDiscriminatorValue, serializeCreateSubscriptionModel, serializePatchSubscriptionModel, serializeSubscriptionModel, type CreateSubscriptionModel, type PatchSubscriptionModel, type SubscriptionModel } from '../models/subscription/index.js';
// @ts-ignore
...
export interface SubscriptionsRequestBuilder extends BaseRequestBuilder<SubscriptionsRequestBuilder> {
     ...
     * @returns {Promise<PaginatedResponseModelSubscription_SubscriptionModel>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<SubscriptionsRequestBuilderGetQueryParameters> | undefined) : Promise<PaginatedResponseModelSubscription_SubscriptionModel | undefined>;
    /**
 ...
 */
export const SubscriptionsRequestBuilderUriTemplate = "{+baseurl}/subscriptions{?from_date*,limit*,offset*,providers*,recurrencies*,search*,to_date*,users*,with_inactive*}";
/**
...
export const SubscriptionsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createPaginatedResponseModelSubscription_SubscriptionModelFromDiscriminatorValue,
