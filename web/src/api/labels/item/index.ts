...
// @ts-ignore
import { createHttpErrorResponseFromDiscriminatorValue, createLabelModelFromDiscriminatorValue, serializeLabelModel, serializeUpdateLabelModel, type HttpErrorResponse, type LabelModel, type UpdateLabelModel } from '../../models/index.js';
// @ts-ignore
