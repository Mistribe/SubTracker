...
// @ts-ignore
import { createHttpErrorFromDiscriminatorValue, createLabelModelFromDiscriminatorValue, serializeCreateLabelModel, serializeLabelModel, type CreateLabelModel, type HttpError, type LabelModel } from '../models/index.js';
// @ts-ignore
...
export interface LabelsRequestBuilder extends BaseRequestBuilder<LabelsRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<LabelsRequestBuilderGetQueryParameters> | undefined) : Promise<LabelModel[] | undefined>;
    /**
     * Create a new label
 ...
 */
export const LabelsRequestBuilderUriTemplate = "{+baseurl}/labels{?with_default*}";
/**
