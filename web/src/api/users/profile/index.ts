...
// @ts-ignore
import { createHttpErrorFromDiscriminatorValue, createUserProfileModelFromDiscriminatorValue, serializeUpdateProfileModel, serializeUserProfileModel, type HttpError, type UpdateProfileModel, type UserProfileModel } from '../../models/index.js';
// @ts-ignore
...
export interface ProfileRequestBuilder extends BaseRequestBuilder<ProfileRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<UserProfileModel | undefined>;
    /**
     ...
     * @throws {HttpError} error when the service returns a 401 status code
     */
     put(body: UpdateProfileModel, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<UserProfileModel | undefined>;
    /**
     * Returns the profile information for the authenticated user
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const ProfileRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createUserProfileModelFromDiscriminatorValue,
    },
    put: {
        uriTemplate: ProfileRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
