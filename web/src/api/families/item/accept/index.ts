...
// @ts-ignore
import { createHttpErrorResponseFromDiscriminatorValue, serializeFamilyAcceptInvitationRequest, type FamilyAcceptInvitationRequest, type HttpErrorResponse } from '../../../models/index.js';
// @ts-ignore
