...
// @ts-ignore
import { createFamilyModelFromDiscriminatorValue, serializeFamilyModel, serializeUpdateFamilyModel, type FamilyModel, type UpdateFamilyModel } from '../../models/family/index.js';
// @ts-ignore
